...
from old.src.app.config.swagger_config import settings as swagger_settings
from old.src.app.config.logging_config import settings as logger_settings, logger_config

from old.src.app.hooks import on_app_startup, on_app_shutdown

from old.src.app.middleware import init_middleware
