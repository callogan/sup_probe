...
class Settings(BaseSettings):
    ...
    contact_name: str | None = Field("Ruslan Kazmiryk", alias="APP_CONTACT_NAME")
    contact_url: AnyUrl | None = Field("https://t.me/callogan", alias="APP_CONTACT_URL")
    contact_email: EmailStr | None = Field("callogan217@gmail.com", alias="APP_CONTACT_EMAIL")
